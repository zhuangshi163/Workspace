...
function addToCart1(goodsId, parentId)
{
  ...
  Ajax.call('flow.php?step=add_to_cart', 'goods=' + goods.toJSONString(), addToCartResponse1, 'POST', 'JSON');
...
function addToCartResponse1(result)
{
  ...
  else
  {
    ...
    {
			if(document.getElementById("shopboxcount")&&result.num){
				document.getElementById("shopboxcount").innerHTML = result.num;
			}
			if(document.getElementById("shopboxprice")&&result.price){
				document.getElementById("shopboxprice").innerHTML = result.price;
			}
			if(document.getElementById("shoploading")){
