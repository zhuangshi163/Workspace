...
function showtime(obj)
{
  ...
  if (dateLeft > 0)
  {
    Temp = "<font color='#101010'>剩余：<font color='#900'><b>"+hourZero+hourLeft+"</b></font> 小时 <font color='#900'><b>" + minuteZero + minuteLeft +"</b></font> 分 <font color='#900'><b>" + secondZero + secondLeft + "</b></font> 秒</font>" ;
  }
  else
  {
    if (hourLeft > 0)
    {
      Temp = "<font color='#101010'>剩余：<font color='#900'><b>" + hourLeft + "</b></font> 小时 <font color='#900'><b>" + minuteZero + minuteLeft + "</b></font> 分 <font color='#900'><b>" + secondZero + secondLeft + "</b></font> 秒</font>";
    }
    else
    {
      if (minuteLeft > 0)
      {
        Temp = "<font color='#101010'>剩余：<b>" + minuteLeft + "</b> 分 <b>" + secondZero + secondLeft + "</b> 秒</font>";
      }
      else
      {
        if (secondLeft > 0)
