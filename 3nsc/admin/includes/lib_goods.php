...
function reformat_image_name($type, $goods_id, $source_img, $position='')
{
    ...
    if (!make_dir(ROOT_PATH.$dir.'/'.$sub_dir.'/index_img'))
    {
    	return false;
    }
    if (!make_dir(ROOT_PATH.$dir.'/'.$sub_dir.'/list_img'))
    {
    	return false;
    }
    ...
    switch($type)
    {
        case 'goods':
            ...
            break;
        case 'index':
            $img_name = $goods_id . '_T_' . $rand_name;
            break;
        case 'list':
            $img_name = $goods_id . '_L_' . $rand_name;
            break;
        case 'goods_thumb':
    ...
    {
    	if (move_image_file(ROOT_PATH.$source_img, ROOT_PATH.$dir.'/'.$sub_dir.'/index_img/'.$img_name.$img_ext))
    	{
    		return $dir.'/'.$sub_dir.'/index_img/'.$img_name.$img_ext;
    	}
    }
    elseif ($position == 'list')
    {
    	if (move_image_file(ROOT_PATH.$source_img, ROOT_PATH.$dir.'/'.$sub_dir.'/list_img/'.$img_name.$img_ext))
    	{
    		return $dir.'/'.$sub_dir.'/list_img/'.$img_name.$img_ext;
    	}
    }
    else
    {
