 ...
 *
 * @access      public
 * @param       int     district_id    地区编号
 * @return      array
 */
function get_stores($district_id)
{
	$sql = "SELECT s.store_id,s.store_remark FROM " . $GLOBALS['ecs']->table('store'). "as s WHERE s.district= '$district_id'";
	return $GLOBALS['db']->GetAll($sql);
}
