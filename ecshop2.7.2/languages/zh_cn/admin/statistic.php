...
$_LANG['store_id'] = '销售门店';
$_LANG['all_store']='全部门店';
$_LANG['order_type'] = '订单状态';
$_LANG['store_id'] = '销售门店';
$_LANG['finished'] = '已完成订单';
$_LANG['await_pay'] = '待付款订单';
$_LANG['unconfirmed'] = '未确认订单';
$_LANG['await_ship'] = '待发货订单';
$_LANG['unprocessed'] = '未处理订单';
$_LANG['unpay_unship'] = '未付款未发货订单';
$_LANG['shipped'] = '已发货订单';
$_LANG['all_suppliers']='全部供货商';
$_LANG['keyword'] = '关键字';
$_LANG['reset'] = '重置';
$_LANG['select_cat'] = '请选择...';
$_LANG['suppliers'] = '供货商';
$_LANG['goods_specification'] = '规格';
$_LANG['goods_number'] = '库存量';
$_LANG['sum_price'] = '零售价小结' ;
$_LANG['wholesale_price_turnover'] = '批发价小结';
$_LANG['cat_name']  = '商品分类';
$_LANG['store']='门店';
$_LANG['wholesale_price'] = '批发价';
$_LANG['total'] = "合计";
