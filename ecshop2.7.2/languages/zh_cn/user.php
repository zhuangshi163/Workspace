...
/* 登录 注册 */
$_LANG['label_username'] = '联系电话';		//联系电话
$_LANG['label_realname'] = '真实姓名';		//真实姓名
$_LANG['label_email'] = '电子邮件';
$_LANG['label_password'] = '登陆密码';
...
$_LANG['label_store'] = '绑定门店';
$_LANG['label_store_select'] = '请选择账号绑定门店';
$_LANG['label_area'] = '所在地区';
$_LANG['select_please'] = '请选择';
$_LANG['login_username'] = '账号';		//联系电话
$_LANG['login_password'] = '密码';		//联系电话
$_LANG['login_prompt'] = '卡号/联系电话/Email';		//联系电话
...
$_LANG['passport_js']['username_empty'] = '- 联系电话不能为空。';
$_LANG['passport_js']['realname_empty'] = '- 真实姓名不能为空。';
$_LANG['passport_js']['username_shorter'] = '- 联系电话长度为 11 位数字。';
$_LANG['passport_js']['username_invalid'] = '- 联系电话只能是由11位数字组成。';
$_LANG['passport_js']['store_empty'] = '- 请选择门店。';
...
$_LANG['passport_js']['email_empty'] = '- Email 不能为空';
...
$_LANG['passport_js']['msg_un_blank'] = '* 该账号不能为空';
$_LANG['passport_js']['msg_un_length'] = '* 手机号码长度为 11 位数字';
$_LANG['passport_js']['msg_un_format'] = '* 该账号含有非法字符';
$_LANG['passport_js']['msg_un_registered'] = '* 该账号已经存在,请重新输入';
...
$_LANG['passport_js']['no_select_store'] = '- 您没有选择绑定的门店';
