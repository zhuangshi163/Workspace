...
$_LANG['sms_url'] = '<a href="'.$url.'"><font style="color: red;">Click here</font></a> to register short message service,If you already have a permit,<a href="'.$url_act.'"><font style="color: red;">To activate</font></a>';
?>